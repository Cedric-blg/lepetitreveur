...
final class PresenceController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, ChildRepository $childRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            // Map submitted child_id (from hidden input) to the entity
    ...
    public function edit(Request $request, Presence $presence, EntityManagerInterface $entityManager, ChildRepository $childRepository): Response
    {
        $form = $this->createForm(PresenceType::class, $presence);
        $form->handleRequest($request);
